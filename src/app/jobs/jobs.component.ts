  ...
  readonly jobs: Job[] = [
    {
      ...
      salary: 'BDT 1.5L – 2.5L/month',
      posted: 'Mar 4, 2026',
      deadline: 'Mar 31, 2026',
      description:
        "Lead the design and development of scalable back-end services for Samsung's global product ecosystem. You will work with a team of international engineers on high-impact projects.",
      skills: ['Java', 'Spring Boot', 'Microservices', 'Kafka', 'AWS'],
      postedBy: "Ariful Islam (Batch '18)",
      featured: true,
    },
    {
      id: 2,
      ...
      salary: 'BDT 80K – 1.2L/month',
      posted: 'Mar 1, 2026',
      deadline: 'Mar 25, 2026',
      description:
        "Build and maintain ML models powering Pathao's recommendation, pricing, and fraud-detection systems. Strong Python and MLOps background required.",
    ...
    },
    {
      ...
      experience: 'Mid Level (2–5 yrs)',
      salary: 'BDT 70K – 1L/month',
      posted: 'Feb 28, 2026',
      deadline: 'Mar 20, 2026',
      description:
        "Develop and maintain consumer-facing features for Bangladesh's largest mobile financial service platform. Collaborate with product, design, and QA teams.",
    ...
    },
    {
      ...
      experience: 'Senior (5–10 yrs)',
      salary: 'USD 90K – 130K/yr',
      posted: 'Mar 3, 2026',
      deadline: 'Apr 5, 2026',
      description:
        'Manage and scale Azure cloud infrastructure for enterprise clients across Southeast Asia. Candidates based in Bangladesh and the region are strongly encouraged to apply.',
    ...
    },
    {
      ...
      salary: 'BDT 15K – 20K/month',
      posted: 'Mar 5, 2026',
      deadline: 'Mar 28, 2026',
      description:
        "Work alongside senior engineers on real product features for Bangladesh's leading e-commerce grocery platform. Open to final-year CSE students and recent graduates.",
    ...
    },
    {
      ...
      experience: 'Mid Level (2–5 yrs)',
      salary: 'BDT 1L – 1.5L/month',
      posted: 'Feb 25, 2026',
      deadline: 'Mar 18, 2026',
      description:
        "Own the product roadmap for Nagad's consumer wallet and payment features. Collaborate with engineering, design, and regulatory teams to ship impactful products.",
    ...
    },
    {
      ...
      experience: 'Mid Level (2–5 yrs)',
      salary: 'BDT 80K – 1.1L/month',
      posted: 'Mar 2, 2026',
      deadline: 'Mar 30, 2026',
      description:
        "Monitor, detect, and respond to security threats across Grameenphone's infrastructure. Perform vulnerability assessments and champion security awareness.",
    ...
    },
    {
      ...
      industry: 'Software Engineering',
      experience: 'Entry Level (0–2 yrs)',
      salary: 'BDT 35K – 50K/month',
      posted: 'Mar 5, 2026',
      deadline: 'Apr 2, 2026',
      description:
        "Build and maintain the frontend for Bangladesh's leading beauty and lifestyle e-commerce platform. Great opportunity for recent graduates to grow fast.",

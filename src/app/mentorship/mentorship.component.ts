...
export class MentorshipComponent {
  readonly areas = [
    'Software Engineering', 'Data Science & AI', 'Cloud & DevOps', 'Cybersecurity',
    'Product Management', 'Career Transition', 'Higher Studies / Research', 'Entrepreneurship',
  ];
  ...
  readonly mentors: Mentor[] = [
    {
      id: 1, name: 'Ariful Islam', batch: 2018, role: 'Senior Software Engineer', company: 'Samsung R&D',
      country: 'Bangladesh', city: 'Dhaka', availability: '2 hrs/week',
      ...
      initials: 'AI', color: 'bg-sky-600', mentees: 12, rating: 4.9,
    },
    {
      id: 2, name: 'Nusrat Jahan', batch: 2019, role: 'ML Engineer', company: 'Google',
      country: 'USA', city: 'San Francisco', availability: '1 hr/week',
      ...
      initials: 'NJ', color: 'bg-violet-600', mentees: 8, rating: 5.0,
    },
    {
      id: 3, name: 'Mahmudul Hasan', batch: 2016, role: 'DevOps Lead', company: 'Thoughtworks',
      country: 'UK', city: 'London', availability: '3 hrs/week',
      ...
      initials: 'MH', color: 'bg-emerald-600', mentees: 15, rating: 4.8,
    },
    {
      id: 4, name: 'Sadia Rahman', batch: 2020, role: 'Product Manager', company: 'Shopify',
      country: 'Canada', city: 'Toronto', availability: '2 hrs/week',
      ...
      initials: 'SR', color: 'bg-rose-600', mentees: 9, rating: 4.7,
    },
    {
      id: 5, name: 'Rakibul Islam', batch: 2015, role: 'Co-Founder & CTO', company: 'TechVenture BD',
      country: 'Bangladesh', city: 'Dhaka', availability: '2 hrs/week',
      ...
      initials: 'RI', color: 'bg-teal-600', mentees: 20, rating: 4.9,
    },
    {
      id: 6, name: 'Nafis Hossain', batch: 2014, role: 'PhD Researcher', company: 'MIT CSAIL',
      country: 'USA', city: 'Boston', availability: '1.5 hrs/week',
      ...
      initials: 'NH', color: 'bg-cyan-600', mentees: 7, rating: 5.0,
    },
  ];

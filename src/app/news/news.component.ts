...
export type NewsCategory = 'All' | 'Announcement' | 'Achievement' | 'Events' | 'Research' | 'Career' | 'Community';
...
export class NewsComponent {
  readonly categories: NewsCategory[] = ['All', 'Announcement', 'Achievement', 'Events', 'Research', 'Career', 'Community'];
  ...
  readonly articles: NewsArticle[] = [
    {
      ...
      summary: 'The CSE DIU Alumni Network has launched a major update with improved search, an enhanced alumni directory, event management, and a new mentorship matching system.',
      ...
      author: 'Platform Team', date: 'March 5, 2026', readTime: '3 min read',
      icon: 'fa-rocket', color: 'bg-violet-100', pinned: true, featured: true,
    },
    {
      id: 2, category: 'Achievement',
      title: 'Alumni Nusrat Jahan (Batch \'19) Joins Google as ML Engineer',
      summary: 'We congratulate Nusrat Jahan on securing a role at Google\'s AI division in San Francisco, working on large-scale ML infrastructure.',
      ...
      author: 'Community Desk', date: 'March 1, 2026', readTime: '2 min read',
      icon: 'fa-trophy', color: 'bg-amber-100', featured: true,
    },
    {
      id: 3, category: 'Events',
      title: 'Grand Alumni Reunion 2026 — Registrations Now Open',
      summary: 'The biggest event on the alumni calendar returns on April 12, 2026. Early-bird registration is open with limited seats.',
      ...
      author: 'Events Committee', date: 'February 28, 2026', readTime: '2 min read',
      icon: 'fa-calendar-check', color: 'bg-emerald-100',
    },
    {
      id: 4, category: 'Research',
      title: 'BanglaBERT++ Paper Accepted at ACL 2025 Findings',
      summary: 'Alumni researchers Nusrat Jahan and Mehedi Hasan\'s paper on contextual Bangla NLP embeddings has been accepted at ACL 2025.',
      ...
      author: 'Research Desk', date: 'February 20, 2026', readTime: '3 min read',
      icon: 'fa-file-lines', color: 'bg-sky-100',
    },
    {
      id: 5, category: 'Career',
      title: 'Alumni Job Board Now Live — 8 Exclusive Openings',
      summary: 'The CSE DIU Alumni Job Board has launched with 8 positions shared exclusively by alumni at Samsung, Google, bKash, Pathao, and more.',
      ...
      author: 'Career Desk', date: 'February 15, 2026', readTime: '2 min read',
      icon: 'fa-briefcase', color: 'bg-rose-100',
    },
    {
      id: 6, category: 'Community',
      title: 'CSE DIU Alumni Endowment Scholarship: First Recipient Announced',
      summary: 'The inaugural recipient of the alumni-funded endowment scholarship has been announced. Meet Rasel Ahmed, current CSE DIU student.',
      ...
      author: 'Community Desk', date: 'February 10, 2026', readTime: '3 min read',
      icon: 'fa-heart', color: 'bg-pink-100',
    },
    {
      id: 7, category: 'Achievement',
      title: 'Rakibul Islam\'s Startup TechVenture BD Raises BDT 3 Crore Seed Round',
      summary: 'CSE DIU alumnus and entrepreneur Rakibul Islam (Batch \'15) has closed a BDT 3 crore seed round for his tech startup TechVenture BD.',
      ...
      author: 'Community Desk', date: 'January 30, 2026', readTime: '3 min read',
      icon: 'fa-chart-line', color: 'bg-teal-100',
    },
    {
      id: 8, category: 'Announcement',
      title: 'Mentorship Programme Opens for Applications — 30 Spots Available',
      summary: 'The CSE DIU Alumni Mentorship Programme is accepting applications for 30 mentee spots mentored by senior alumni from Google, Microsoft, Samsung, and more.',
      ...
      author: 'Mentorship Team', date: 'January 25, 2026', readTime: '2 min read',
      icon: 'fa-handshake', color: 'bg-indigo-100', pinned: true,
    },
  ];
  ...
  setCategory(c: NewsCategory) { this.activeCategory.set(c); }
